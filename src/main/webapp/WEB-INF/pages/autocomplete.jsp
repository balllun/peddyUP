...
<script>
 ...
 function a(){
	 ...
	 /* $.ajax({
	  ...
	  $.getJSON( "getname",  function( data ) {
		 oop = new person(data);
		 t();
		/*   response($.map(msg, function (items) {
             return items; 
         }));  */
		 return Tags;
       }) ; 
 ...
 var Tags = [];
  function t(){
	 return Tags=oop.name 
	 console.log(Tags); 
	 }   
 
	/*  $.getJSON("getname", function(msg){
		 response($.map(msg, function (items) {
             return items;
         }));
		});    */
 ...
 $(function() {
	...
	/*  var availableTags = response(t);  */
/*  var availableTags = [ "JDH MAX MANSO 414/8", "JDH MAX MANSO 414/8",
				"JDH MAX MANSO", "JDH MAX MANSO 414/8", "JDH MAX MANSO ",
				"พ่อปู่", "แม่ปู่", "ปู่", "พ่อย่า", "แม่ย่า", "ย่า", "พ่อ",
				"พ่อตา", "แม่ตา", "ตา", "พ่อยาย", "แม่ยาย", "ยาย", "แม่", "ลูก" ];   */
		  /* var availableTags = [ "ActionScript", "AppleScript", "Asp", "BASIC",
		      				"C", "C++", "Clojure", "COBOL", "ColdFusion", "Erlang",
		      				"Fortran", "Groovy", "Haskell", "Java", "JavaScript", "Lisp",
		      				"Perl","Nack", "PHP", "Python", "Ruby", "Scala", "Scheme" ];    */

		//  var pedigreeTags = [ $("#loadVar").load('loadVar'); ];   
		...
		$("#tags").autocomplete({
			...
			/* source: function( request, response ) {
		        ...
		        $.getJSON( "getname", request, function( data, status, xhr ) {
		          response( data );
		        });
		      } */
		//source: t
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-left">
					...
					<li><a class="nav-link" href="Printing">พิมพ์ใบพันธุ์ประวัติ</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#"><i class="fa fa-sign-in"></i>&nbsp;สมัครสมาชิก</a></li>
...
<body>
		...
		<div class="row">
			<div class="col-sm-offset-2 col-sm-6">
				...
				<form:form class="form-horizontal" role="form" method="POST"
					commandName="pedigree" modelAttribute="pedigree">
					<div class="form-group">
						<label class="control-label col-sm-2" for="pwd">Pedigree</label>
						<div class="col-sm-6">
							<form:select class="form-control" path="CName"
								items="${pedigreeList}" />
						</div>
					</div>
				</form:form>
				...
				<!-- 			
					<form>
    <select class="form-control" name="Country" id="country-selector" autofocus="autofocus" autocorrect="off" autocomplete="off">
	...
	<footer class="footer">
		<div class="container">
			<p>
				<font color="white">© 2014-2015 Pedigree Record and Search
					System</font>
			</p>
			<p class="text-muted">
				<font color="grey">University of Phayao</font>
			</p>
		</div>
	</footer>
...
<script>
	function confirm() {
		/* swal("Registed!", "successful!", "success") */
		swal({
