...
<%int i = 1;%>
<c:forEach items="${pedigreeList}" var="pedigree"  begin="0"  end="80"  step="1">
	<tr>
		...
		<sec:authorize access="hasRole('Admin')"><td class="text-center"><button class="btn btn-danger"
				value="${pedigree.id}" onclick="deleteSearch(this)">
				<i class="fa fa-times"></i>
			</button></td>	</sec:authorize>
	</tr>
</c:forEach>